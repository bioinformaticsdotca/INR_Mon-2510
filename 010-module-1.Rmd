...
Slides can be found [here](./01-IntroToR_Maximiliane_Jousse/Slides/IntroToR_CBHWorkshop.pptx).

##### 1. R basics
In the first module of the workshop, the goals are to familiarize with the language and the logic behind it; Get started with R studio and create your first project; Create your first `.R` file to write down the live code; and get comfortable with installing packages.

**Module content:**
-   Seeking help
-   Installing packages

[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/01GettingStarted.Rmd)
...
[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/02DataTypes.Rmd)
...
[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/03ControlStructuresAndFunctions.Rmd)
...
[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/04BasicDataManipulation.Rmd)
...
[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/05AdvancedDataManipulation.Rmd)
...
[**Script**](./Practical1_IntroToR_Maximiliane_Jousse/Exercises/scripts/06GeneratingOutputs.Rmd)
